...
public class SalesOrderDto {
    ...
    public SalesOrderDto(Long id, String soNumber, String customerName,
                         SalesOrderStatus status, LocalDateTime createdAt,
                         LocalDateTime confirmedAt, List<SalesOrderItemDto> items) {
        this.id = id;
